...
Drop easytrade.jar into your mods folder.

**Usage**

    Place a lectern and let a villager claim it
    Look at the villager (within 3 blocks, don't sneak)
    The panel appears above their head with all their trades
    Right-click the villager to open the trade menu, then right-click any trade to pin it (max 4)
    Press E to see your pinned trades and unpin them with the X button
    Press F7 to open the wanted-trades menu — search for an item or enchantment and click it to add it
    When a wanted trade is for sale, the name turns green and a sound plays
